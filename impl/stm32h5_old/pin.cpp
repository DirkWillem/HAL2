...
void Pin::Initialize(PinId id, hal::PinDirection dir, hal::PinPull pull,
...
Gpo::Gpo(PinId pin, hal::PinPull pull, hal::PinMode mode) noexcept
    : pin{pin} {
...
Gpi::Gpi(PinId pin, hal::PinPull pull, hal::PinMode mode) noexcept
    : pin{pin} {
