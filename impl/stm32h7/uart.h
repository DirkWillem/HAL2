...
#include <stm32h7/pin.h>

#include <stm32h7/mappings/uart_pin_mapping.h>
...
template <Core C, UartId Id, hal::DmaPriority Prio = hal::DmaPriority::Low>
using UartTxDma = DmaChannel<C, Id, UartDmaRequest::Tx, Prio>;

template <Core C, UartId Id, hal::DmaPriority Prio = hal::DmaPriority::Low>
using UartRxDma = DmaChannel<C, Id, UartDmaRequest::Rx, Prio>;
...
class UartImpl : public hal::UsedPeripheral {
 ...
 public:
  ...
  using TxDmaChannel = DmaChannel<CurrentCore, Id, UartDmaRequest::Tx>;
  using RxDmaChannel = DmaChannel<CurrentCore, Id, UartDmaRequest::Rx>;
...
using Uart4   = Uart<UartId::Uart4>;
using Uart5   = Uart<UartId::Uart5>;
using Usart6  = Uart<UartId::Usart6>;
using Uart7   = Uart<UartId::Uart7>;
using Uart8   = Uart<UartId::Uart8>;
