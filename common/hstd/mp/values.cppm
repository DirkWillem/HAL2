...
template <typename T, typename E>
concept IsValues = IsValuesHelper<T, E>::value;
 ...
 */
using MergeValues = typename MergeValuesHelper<T, Vs...>::Result;
...
using MergeValuesWithIndex =
    typename MergeValuesWithIndexHelper<0, T, Vs...>::Result;
